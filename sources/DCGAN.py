...
class DCGAN:
    def __init__(self, params, normal_weight_init=True):
        ...
        """
        self.generator = GeneratorConvTranspose(params["z_dim"], params["gen"]["n_feature"], params["gen"]["n_channel"],
                                                n_conv_block=params["n_conv_block"]).to(var.device)
        """
        self.generator = GeneratorUpSample(params["z_dim"], params["gen"]["n_feature"], params["gen"]["n_channel"],
                                           params["output_size"], n_conv_block=params["n_conv_block"]).to(var.device)
